import { c as create_ssr_component, b as add_attribute, e as escape, a as subscribe, v as validate_component, d as each } from "../../chunks/index2.js";
import { w as writable } from "../../chunks/index.js";
const todos = writable([]);
const TodoForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let todo = "";
  return `<form class="my-6"><div class="flex flex-col text-sm mb-2"><label class="font-bold mb-2 text-gray-800" for="todo">ToDo</label>
        <input type="text" name="todo" placeholder="What do you have to do?" class="appearance-none shadow-sm border border-gray-200 p-2 focus:outline-none focus:border-gray-500 rounded-lg"${add_attribute("value", todo, 0)}></div>
...
const Todo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<li class="bg-white flex items-center shadow-sm border border-gray-200 rounded-lg my-2 py-2 px-4"><input name="completed" type="checkbox" ${todo.completed ? "checked" : ""} class="mr-2 form-checkbox h-5 w-5">
    ...
    <button type="button" class="text-sm bg-red-500 hover:bg-red-600 text-white py-1 px2 rounded focus:outline-none focus:shadow-outline">Delete </button></li>`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $todos, $$unsubscribe_todos;
  $$unsubscribe_todos = subscribe(todos, (value) => $todos = value);
  $$unsubscribe_todos();
  return `<main><h1 class="text-2xl font-bold text-center text-gray-800 md:text-3xl">ToDoList</h1>
